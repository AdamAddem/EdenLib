...
template <class T> concept fundamental_c = std::is_fundamental_v<T>;
...
template <template <class...> class A, class... T> concept is_a_c = detail::is_a<A, T...>::value;
template <class T, class... Ts> concept is_one_of = (same_c<T, Ts> or ...);
